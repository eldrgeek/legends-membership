 ...
 * across all users (not just whoever can reproduce it). Reviewed in
 * admin-bill-log.html.
 *
 * Inserts with the service-role key (bypasses RLS). Requires
 * SUPABASE_SERVICE_ROLE_KEY in Netlify env (already set for submit-feedback).
 *
 * Apply this SQL in the Supabase SQL editor to enable:
